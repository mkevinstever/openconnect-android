		...
		if (savedInstanceState == null) {
			...
			if (fragName != null) {
				try {
					...
					Log.e(TAG, "Fragment class not found: " + FRAGMENT_PREFIX + fragName, e);
					finish();
				} catch (InstantiationException e) {
					Log.e(TAG, "Unable to instantiate fragment: " + FRAGMENT_PREFIX + fragName, e);
					finish();
				} catch (IllegalAccessException e) {
					Log.e(TAG, "Illegal access when instantiating fragment: " + FRAGMENT_PREFIX + fragName, e);
					finish();
				} catch (Exception e) {
				...
				Log.e(TAG, "Fragment name is null");
				finish();
			}
		}
	}
